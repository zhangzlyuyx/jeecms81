...
public abstract class BaseCmsUser  implements Serializable {
	...
	private java.util.Set<com.jeecms.cms.entity.main.CmsThirdAccount> thirdAccounts;
	...
	public java.util.Set<com.jeecms.cms.entity.main.CmsThirdAccount> getThirdAccounts() {
		return thirdAccounts;
	}

	public void setThirdAccounts(java.util.Set<com.jeecms.cms.entity.main.CmsThirdAccount> thirdAccounts) {
